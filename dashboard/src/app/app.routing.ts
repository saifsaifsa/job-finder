...
export const appRoutes: Route[] = [
    ...
    // TODO check if has ROLE_PUBLISHER
    {
        ...
        children: [
            ...
            {path: 'training',loadChildren: () => import('app/modules/userFront/training/training.module').then((m) => m.TrainingModuleUser),},
            {path: 'company',loadChildren: () => import('app/modules/userFront/company/company.module').then((m) => m.CompanyModuleUser),},
            { path: 'offre',loadChildren: () => import('app/modules/userFront/offres/offres.module').then((m) => m.OffresModuleAdmin), },
            { path: 'offre/:id',loadChildren: () => import('app/modules/userFront/offresDetail/offresDetail.module').then((m) => m.OofresDetailModuleAdmin), },            { path: 'success',loadChildren: () => import('app/modules/userFront/success-page/success-page.module').then((m) => m.SuccessModule), },
            { path: 'cancel',loadChildren: () => import('app/modules/userFront/cancel-page/cancel-page.module').then((m) => m.CancelModule), },
        ],
    },
];
